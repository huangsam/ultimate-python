...
class Server:
    ...
    @classmethod
    def create(cls, role: str, provider: str = _CLOUD_PROVIDER) -> "Server":
        """Create server with autogenerated SSID."""
        return cls(uuid4().hex, role, provider)

    def __init__(self, ssid: str, role: str, provider: str) -> None:
        self.ssid = ssid
        self.role = role
...
class ServerRegistry:
    ...
    def __init__(self) -> None:
        self._servers: weakref.WeakSet[Server] = weakref.WeakSet()
...
def setup_and_teardown_servers(registry: ServerRegistry) -> None:
    """Explicitly setup and implicitly teardown servers."""
    app_servers: dict[str, set[Server]] = {}
