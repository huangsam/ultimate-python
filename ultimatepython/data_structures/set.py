...
def main() -> None:
    ...
    # Use `pop` to return an arbitrary element from a set
    arbitrary_element = simple_set.pop()
    assert arbitrary_element in {0, 1, 2, 3, 4}
    assert arbitrary_element not in simple_set
