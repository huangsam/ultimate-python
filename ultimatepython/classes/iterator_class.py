"""
Iterator classes implement the __iter__ and __next__ magic methods. This
module defines an employee iterator class that goes iterates through each
employee in a hierarchy one-by-one. This module also shows how a similar
thing can be achieved with a generator function.
"""
