...
def main():
    ...
    # Bitwise NOT (~) operator inverts all bits of an integer. It returns the
    # one's complement of the integer.
    result_not_a = ~a  # Binary: 11111010 (Decimal: -6)
    assert result_not_a == -6

    # Bitwise left shift (<<) operator shifts the bits of an integer to the left
    # by a specified number of positions, filling with zeros.
